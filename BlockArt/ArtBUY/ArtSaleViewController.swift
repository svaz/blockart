...
import UIKit
import RMessage
class ArtSaleViewController: UIViewController {
...
extension ArtSaleViewController{
...
extension ArtSaleViewController: UITableViewDelegate, UITableViewDataSource {
  ...
  func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    performSegue(withIdentifier: "myArtDetailBUYSegue", sender: self)
  }
